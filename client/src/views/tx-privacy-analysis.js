...
, 'exotic-detection-uih2': [
    'info'
  , 'Unnecessary input heuristic'
  , 'This transaction has seemingly unnecessary inputs that are not typically added by consumer wallet software with unsophisticated coin selection algorithms.'
  , 'https://en.bitcoin.it/wiki/Privacy#Unnecessary_input_heuristic'
  ]
